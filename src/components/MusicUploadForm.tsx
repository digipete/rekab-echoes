...
export const MusicUploadForm = ({ genres, onUploadSuccess }: MusicUploadFormProps) => {
  ...
  const availableGenres = genres.filter(genre => genre !== "All");
  ...
  const removeFile = () => {
    ...
    const fileInput = document.getElementById("music-file-upload") as HTMLInputElement;
  ...
  const onSubmit = async (values: UploadFormValues) => {
    ...
    try {
      ...
      const fileName = `music/${Date.now()}-${values.file.name}`;
      ...
      // Insert music track metadata into database
